...
const FACE_STYLE = 'absolute inset-0 border border-white/10 flex items-center justify-center font-mono text-[9px] text-white tracking-widest uppercase select-none';
